...
var enUS = &Language{
	...
	validation: validationLines{
		rules: map[string]string{
			...
			"unique.string.element":              "The :field element value has already been taken.",
			"unique.numeric.element":             "The :field element value has already been taken.",
			"exists":                             "The :field does not exist.",
			"exists.string":                      "The :field does not exist.",
			"exists.numeric":                     "The :field does not exist.",
			"exists.string.element":              "The :field element value does not exist.",
			"exists.numeric.element":             "The :field element value does not exist.",
		},
