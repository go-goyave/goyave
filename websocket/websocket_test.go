...
func TestAdapterOnError(t *testing.T) {
	req := testutil.NewTestRequest(t.Context(), http.MethodGet, "/websocket", nil)
...
func TestUpgrade(t *testing.T) {
	...
	server.Router().Subrouter("/websocket").Controller(upgrader)
...
func TestCloseConnectionClosed(t *testing.T) {
	...
	server.Router().Subrouter("/websocket").Get("", func(response *goyave.Response, request *goyave.Request) {
		defer wg.Done()
