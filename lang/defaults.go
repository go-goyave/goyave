...
var enUS = &Language{
	...
	validation: validationLines{
		rules: map[string]string{ // TODO update default lang
			...
			"float32.array":                    "The :field values must be numeric.",
			"float64":                          "The :field must be numeric.",
			"float64.array":                    "The :field values must be numeric.",
			"int":                              "The :field must be an integer.",
			"int.array":                        "The :field values must be integers.",
			"int8":                             "The :field must be an integer.",
			"int8.array":                       "The :field values must be integers.",
			"int16":                            "The :field must be an integer.",
			"int16.array":                      "The :field values must be integers.",
			"int32":                            "The :field must be an integer.",
			"int32.array":                      "The :field values must be integers.",
			"int64":                            "The :field must be an integer.",
			"int64.array":                      "The :field values must be integers.",
			...
			"uint8.array":                      "The :field values must be positive integers.",
			"uint16":                           "The :field must be a positive integer.",
			"uint16.array":                     "The :field values must be positive integers.",
			"uint32":                           "The :field must be a positive integer.",
			"uint32.array":                     "The :field values must be positive integers.",
			"uint64":                           "The :field must be a positive integer.",
			"uint64.array":                     "The :field values must be positive integers.",
			...
			"in_field":                         "The :field doesn't exist in the :other.",
			"in_field.array":                   "The :field values don't exist in the :other.",
			"not_in_field":                     "The :field exists in the :other.",
			"not_in_field.array":               "The :field values exist in the :other.",
			...
			"unique.string":                    "The :field has already been taken.",
			"unique.numeric":                   "The :field has already been taken.",
			"unique.string.array":              "The :field value has already been taken.",
			"unique.numeric.array":             "The :field value has already been taken.",
			"exists":                           "The :field does not exist.",
			"exists.array":                     "At least one of the :field values do not exist.",
			"exists.string":                    "The :field does not exist.",
			"exists.numeric":                   "The :field does not exist.",
			"exists.string.array":              "The :field value does not exist.",
