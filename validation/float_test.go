...
func TestFloat32Validator(t *testing.T) {
	...
	cases := []struct {
		...
		{value: int32(math.MaxInt32), want: true, wantValue: float32(math.MaxInt32)},
		{value: int64(math.MaxInt64), want: true, wantValue: float32(math.MaxInt64)},
		{value: int(math.MaxInt), want: true, wantValue: float32(math.MaxInt)},
		...
		{value: int32(math.MinInt32), want: true, wantValue: float32(math.MinInt32)},
		{value: int64(math.MinInt64), want: true, wantValue: float32(math.MinInt64)},
		{value: int(math.MinInt), want: true, wantValue: float32(math.MinInt)},
...
func TestFloat64Validator(t *testing.T) {
	...
	cases := []struct {
		...
		{value: int64(math.MaxInt64), want: true, wantValue: float64(math.MaxInt64)},
		{value: int(math.MaxInt), want: true, wantValue: float64(math.MaxInt)},
		...
		{value: int64(math.MinInt64), want: true, wantValue: float64(math.MinInt64)},
		{value: int(math.MinInt), want: true, wantValue: float64(math.MinInt)},
